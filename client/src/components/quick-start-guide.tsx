          ...
          <div className="flex space-x-4">
            <button 
              className={`px-4 py-2 text-sm font-medium border-b-2 transition-colors ${
                view === 'guide' ? 'border-primary text-primary' : 'border-transparent text-muted-foreground hover:text-foreground'
              }`}
            ...
            <button 
              className={`px-4 py-2 text-sm font-medium border-b-2 transition-colors ${
                view === 'features' ? 'border-primary text-primary' : 'border-transparent text-muted-foreground hover:text-foreground'
              }`}
            ...
            <button 
              className={`px-4 py-2 text-sm font-medium border-b-2 transition-colors ${
                view === 'resources' ? 'border-primary text-primary' : 'border-transparent text-muted-foreground hover:text-foreground'
              }`}
        ...
        {view === 'guide' && (
          <div className="py-4">
            <div className="flex justify-between items-center mb-4">
              ...
              <Button variant="default" size="sm" onClick={() => handleNavigate("/home")}>
                Start Guided Setup
              </Button>
            </div>
          ...
          <div className="py-4">
            ...
            <div className="space-y-4">
              <div className="border rounded-lg p-4">
                ...
                <Button variant="link" className="px-0 py-2" onClick={() => handleNavigate("/resources/best-practices")}>
                  Read Guide
                </Button>
              </div>
              ...
              <div className="border rounded-lg p-4">
                ...
                <Button variant="link" className="px-0 py-2" onClick={() => handleNavigate("/resources/templates")}>
                  Get Templates
                </Button>
              </div>
              ...
              <div className="border rounded-lg p-4">
                ...
                <Button variant="link" className="px-0 py-2" onClick={() => handleNavigate("/resources/tutorials")}>
                  Watch Tutorials
                </Button>
              </div>
              ...
              <div className="border rounded-lg p-4">
                ...
                <Button variant="link" className="px-0 py-2" onClick={() => handleNavigate("/resources/case-studies")}>
                  View Case Studies
                </Button>
              </div>
            </div>
