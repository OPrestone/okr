...
export default function OneOnOne() {
  ...
  const filteredUsers = users && searchQuery
    ? users.filter(user => 
  ...
  const teamMembers = filteredUsers?.filter(user => user.id !== currentUserId) || [];
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Select 
                      onValueChange={setMeetingEndTime} 
          ...
          {teamMembers.length > 0 ? (
              ...
              <Card key={user.id} className="border">
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center justify-start mt-4">
                    <div className="flex-1">
                      <span className="text-amber-500 text-xs font-medium">❋ Suggestion</span>
                    </div>
            ...
            <div className="col-span-full text-center py-12 text-gray-500">
              {searchQuery ? (
                ...
                <p>No team members available. Add team members to schedule 1:1 meetings.</p>
              )}
            </div>
          )}
        </div>
