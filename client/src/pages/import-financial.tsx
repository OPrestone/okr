...
import { z } from "zod";
import { CalendarIcon, Upload, Link2 } from "lucide-react";
...
const formSchema = insertFinancialDataSchema.extend({
  ...
  profitAfterTaxMargin: z.string().optional().transform((val) => (val ? parseFloat(val) : null)),
  cumulativeAudience: z.string().optional().transform((val) => (val ? parseInt(val) : null)),
});
          ...
          <Card>
            ...
            <CardFooter className="bg-gray-50 border-t rounded-b-lg">
              <div className="text-xs text-gray-500 w-full">
                <h4 className="font-medium text-gray-700 mb-1">Need help importing data?</h4>
                <p>Download our <a href="#" className="text-primary">template file</a> or check the <a href="#" className="text-primary">import guide</a> for help.</p>
              </div>
            </CardFooter>
          </Card>
        </div>
