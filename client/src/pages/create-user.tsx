...
const accessGroups = [
  {
    id: "admin",
    label: "Admin",
    description: "Full system access with all permissions. Can manage users, settings, OKRs, and all other system functionalities."
  },
  {
    id: "executive",
    label: "Executive",
    description: "System-wide visibility. Can view all Objectives and Key Results (OKRs) across the organization. Has access to check-ins and 1:1 meeting data across all teams."
  },
  {
    id: "team_leader",
    label: "Team Leader",
    description: "Management rights limited to their specific team. Can create, edit, and manage their team's OKRs and monitor progress."
  },
  {
    id: "user",
    label: "User",
    description: "Limited to viewing their assigned team's OKRs and objectives. Can edit Key Results assigned specifically to them."
  }
];
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-neutral-600">Create a new user account in the OKR system</p>
      </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col">
                    ...
                    <FormDescription>
                      The person who manages this user
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
