...
const teamFormSchema = insertTeamSchema.extend({
  ...
  description: z.string().min(5, "Description must be at least 5 characters").max(200, "Description must be less than 200 characters").nullable().optional(),
...
export default function CreateTeam() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-neutral-900 mb-2">Create New Team</h1>
        <p className="text-neutral-600">Fill in the details to create a new team in the organization</p>
      </div>
